...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<?php echo U('News/news_edit');?>" method="post">
	  <input type="hidden" value="<?php echo ($info[0]['id']); ?>" name="id"></input>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<select name="category_id" class="select">
				   <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option <?php if($info[0]['category_id'] == $v['id']): ?>selected="selected"<?php endif; ?> value="<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>	
				</select>
				</span>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="radio" <?php if($info[0]['is_hot'] == 1): ?>checked="checked"<?php endif; ?> name="is_hot" id="is_hot_1" value="1"></input>
				<input type="radio" <?php if($info[0]['is_hot'] == 2): ?>checked="checked"<?php endif; ?> name="is_hot" id="is_hot_2" value="2"></input>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>是否放在首页：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="radio" <?php if($info[0]['is_index'] == 1): ?>checked="checked"<?php endif; ?> name="is_index" id="is_index_1" value="1"></input>
				<input type="radio" <?php if($info[0]['is_index'] == 2): ?>checked="checked"<?php endif; ?> name="is_index" id="is_index_2" value="2"></input>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
	     ...
	     <div class="row cl">
			...
			<input name="info" value="<?php echo ($info[0]['content']); ?>" type="hidden" id="info">
