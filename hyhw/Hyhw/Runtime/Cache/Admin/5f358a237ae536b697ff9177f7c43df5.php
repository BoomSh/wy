...
<body>
<form method="get" action="/index.php/Admin/Advertisement/advertisement_list" id="form2">
...
<form method="post" id="form1" action="/index.php/Admin/Advertisement/advertisement_del">
	<input type="hidden" value="" id="type" name="type"></input>
	<input type="hidden" value="" id="ids" name="ids"></input>
	<input type="hidden" value="" id="pids" name="pids"></input>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:__doPostBack(2);"  class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" data-title="添加资讯" data-href="article-add.html"  href="<?php echo U('Advertisement/advertisement_add');?>"><i class="Hui-iconfont">&#xe600;</i> 添加资讯</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			   <?php if(is_array($info)): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr class="text-c">
					<td><input type="checkbox" id="chkId_<?php echo ($k); ?>"  name="chkId[<?php echo ($k); ?>]"><input type="hidden" name="hidId[<?php echo ($k); ?>]" id="hidId_<?php echo ($k); ?>" value="<?php echo ($v["id"]); ?>|<?php echo ($v["place_id"]); ?>"></input></td>
					<td><?php echo ($v["id"]); ?></td>
					...
					<td><?php echo (advPlace($v["place_id"])); ?></td>
					<td><?php echo ($v["sort_id"]); ?></td>
					
					<!-- <td class="td-status"><span class="label label-success radius">已发布</span></td> -->
					<td class="f-14 td-manage"><!-- <a style="text-decoration:none" onClick="article_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> --> <a style="text-decoration:none" class="ml-5"  href="<?php echo U('Advertisement/advertisement_edit',array('id'=>$v['id']));?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5"  href="javascript:__doPostBack(1,<?php echo ($v["id"]); ?>,<?php echo ($v["place_id"]); ?>);" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
