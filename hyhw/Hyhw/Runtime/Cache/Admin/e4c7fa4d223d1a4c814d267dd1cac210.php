...
<body>
<form method="get" action="/index.php/Admin/News/news_list" id="form2">
...
<form method="post" id="form1" action="/index.php/Admin/News/news_del">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:__doPostBack(2);"  class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" data-title="添加资讯" data-href="article-add.html"  href="<?php echo U('News/news_add');?>"><i class="Hui-iconfont">&#xe600;</i> 添加资讯</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			   <?php if(is_array($info)): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr class="text-c">
					...
					<!-- <td><?php echo (str_decode($v["content"])); ?></td> -->
					<td><?php echo ($v["add_time"]); ?></td>
					<td><?php echo ($v["sort_id"]); ?></td>
					<td><?php echo (is_info($v["is_index"])); ?></td>
					<td><?php echo (is_info($v["is_hot"])); ?></td>
					<td><?php echo (newsCategory($v["category_id"])); ?></td>
					<td><img style="height: 60px" class="img_style" src="<?php echo ($v["img_url"]); ?>"></td>
					
					<!-- <td class="td-status"><span class="label label-success radius">已发布</span></td> -->
					<td class="f-14 td-manage"><!-- <a style="text-decoration:none" onClick="article_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> --> <a style="text-decoration:none" class="ml-5"  href="<?php echo U('News/news_edit',array('id'=>$v['id']));?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5"  href="javascript:__doPostBack(1,<?php echo ($v["id"]); ?>);" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
