...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<?php echo U('Project/projectCountry_add');?>" method="post">
		<div class="row cl">
		...
		<div class="row cl">
		    <dl id="div_albums_container" style="margin-bottom: ">
			    ...
			    <dd class="col-xs-8 col-sm-9">
			     <input name="img_url1" id="img_url1" class="input normal upload-path" type="text" style="width: 500px;height: 30px;border: solid 1px #ddd;">
		...
		<div class="row cl">
		    <dl id="div_albums_container" style="margin-bottom: ">
			    ...
			    <dd class="col-xs-8 col-sm-9">
			     <input name="img_url2" id="img_url2" class="input normal upload-path" type="text" style="width: 500px;height: 30px;border: solid 1px #ddd;">
			      <div class="upload-box upload-img"></div>
			      <input name="hidFocusPhoto" type="hidden" id="hidFocusPhoto" class="focus-photo" />
			      <div class="photo-list">
			        <ul>
		...
		<div class="row cl">
		    <dl id="div_albums_container" style="margin-bottom: ">
			    ...
			    <dd class="col-xs-8 col-sm-9">
			     <input name="img_url3" id="img_url3" class="input normal upload-path" type="text" style="width: 500px;height: 30px;border: solid 1px #ddd;">
			      <div class="upload-box upload-img"></div>
			      <input name="hidFocusPhoto" type="hidden" id="hidFocusPhoto" class="focus-photo" />
			      <div class="photo-list">
			        <ul>
		...
		<div class="row cl">
		    <dl id="div_albums_container" style="margin-bottom: ">
			    ...
			    <dd class="col-xs-8 col-sm-9">
			     <input name="img_url4" id="img_url4" class="input normal upload-path" type="text" style="width: 500px;height: 30px;border: solid 1px #ddd;">
			      <div class="upload-box upload-img"></div>
			      <input name="hidFocusPhoto" type="hidden" id="hidFocusPhoto" class="focus-photo" />
			      <div class="photo-list">
			        <ul>
		...
		<div class="row cl">
		    <dl id="div_albums_container" style="margin-bottom: ">
			    ...
			    <dd class="col-xs-8 col-sm-9">
			     <input name="img_url5" id="img_url5" class="input normal upload-path" type="text" style="width: 500px;height: 30px;border: solid 1px #ddd;">
			      <div class="upload-box upload-img"></div>
			      <input name="hidFocusPhoto" type="hidden" id="hidFocusPhoto" class="focus-photo" />
			      <div class="photo-list">
			        <ul>
	     ...
	     <div class="row cl">
			...
			<input name="info1" type="hidden" id="info1">
		...
		<div class="row cl">
			...
			<input name="info2" type="hidden" id="info2">
			<!-- <input type="button" value="预览"></input> -->
		</div>
		<div class="row cl">
			...
			<input name="info3" type="hidden" id="info3">
			<!-- <input type="button" value="预览"></input> -->
		</div>
		<div class="row cl">
			...
			<input name="info4" type="hidden" id="info4">
			<!-- <input type="button" value="预览"></input> -->
		</div>
		<div class="row cl">
			...
			<input name="info5" type="hidden" id="info5">
			<!-- <input type="button" value="预览"></input> -->
		</div>
		<div class="row cl">
