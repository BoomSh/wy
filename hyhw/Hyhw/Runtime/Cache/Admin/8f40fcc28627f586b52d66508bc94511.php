...
<body>
<form method="get" action="/index.php/Admin/Project/projectCountry_list" id="form2">
...
<form method="post" id="form1" action="/index.php/Admin/Project/projectCountry_del">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:__doPostBack(2);"  class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" data-title="添加资讯" data-href="article-add.html"  href="<?php echo U('Project/projectCountry_add');?>"><i class="Hui-iconfont">&#xe600;</i> 添加资讯</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody>
			   <?php if(is_array($info)): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr class="text-c">
					...
					<td><img style="height: 60px" class="img_style" src="<?php echo ($v["advantage_img"]); ?>"></td>
					<td><img style="height: 60px" class="img_style" src="<?php echo ($v["welfare_img"]); ?>"></td>
					<td><img style="height: 60px" class="img_style" src="<?php echo ($v["education_img"]); ?>"></td>
					<td><img style="height: 60px" class="img_style" src="<?php echo ($v["travel_img"]); ?>"></td>
					<td><img style="height: 60px" class="img_style" src="<?php echo ($v["medical_img"]); ?>"></td>
					
					<!-- <td class="td-status"><span class="label label-success radius">已发布</span></td> -->
					<td class="f-14 td-manage"><!-- <a style="text-decoration:none" onClick="article_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a> --> <a style="text-decoration:none" class="ml-5"  href="<?php echo U('Project/projectCountry_edit',array('id'=>$v['id']));?>" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5"  href="javascript:__doPostBack(1,<?php echo ($v["id"]); ?>);" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
function __doPostBack(type,id="",pid=""){
	layer.confirm('确认要删除么？删除国家之后对应国家的所有项目也都删除，且不可恢复', {
           btn: ['确认','取消'] //按钮
			}, function(){
			  $('#type').val(type);
			    //单个删除
