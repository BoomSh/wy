...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="<?php echo U('Advertisement/advertisement_cat_edit');?>" method="post">
	 <input type="hidden" value="<?php echo ($info[0]['id']); ?>" name="id"></input>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo ($info[0]['name']); ?>" datatype="*" placeholder="" id="" name="name" nullmsg="请填写广告位！">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  datatype="*" value="<?php echo ($info[0]['title']); ?>" placeholder="" id="" name="title" nullmsg="请填广告标识符！">
			</div>
			<div><div class="Validform_checktip"></div></div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="number" class="input-text" value="<?php echo ($info[0]['sum']); ?>" placeholder="" id="" name="sum">
			</div>
		</div>
